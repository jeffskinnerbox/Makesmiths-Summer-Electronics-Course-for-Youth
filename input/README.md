...
reads to generate the course deliverables under `lesson_plans/` (syllabus, BOM, and per-class lesson plans)
and the lecture notes under `lecture_notes/`. `my-vision.md` is the primary input to every skill; the other
