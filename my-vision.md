...
this is my vision of how the [Makersmiths'][06] coarse
called [Summer Electronics Course for Middle Schoolers][07]
...
(Kit [Pack 1][09] mirrors Experiments 1–11 in Chapters 1 & 2 of the [book][02]
and includes a digital multi-meter and batteries.)

## Electronics Primer Course at Makersmiths
I'm preparing to teach a makerspace course for middle school students.
This course is a primer for electricity & electronics concepts.
I view this Electronics Primer course as first part of what could be a three part course outlined in `NOTES.md`.
At this time, only this course is being planned & developed.
The syllabus for this Electronics Primer course is documented in `electronics-syllbus.md`.
...
|:------:|:------:|:------:|
| `/syllabus_generator` | `my-vision.md` | `electronics-syllabus.md` |
| `/lesson_plan_generator` | `my-vision.md`, `electronics-syllabus.md`, "Make: Electronics, 2nd Edition"  | `class-00-lesson-plan.md` |
| `/explainer` | "Make: Electronics, 2nd Edition" | `class-00-lecture-notes.md` |
| `/history_and_application` | "Make: Electronics, 2nd Edition"  | `class-00-lecture-notes.md` |
| `/theory_of_operation` | "Make: Electronics, 2nd Edition"  | `class-00-lecture-notes.md` |
